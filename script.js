const speakerData = {
  ...
  katou: { name: "加藤 雅大", company: "ワンダープラネット株式会社", title: "執行役員SEED 管掌", img: "image/katou.webp", bio: "ワンダープラネット株式会社所属。開発ディレクションからデータ分析まで幅広く担当。スマートフォン向けゲーム「クラッシュフィーバー」の初期には運営ディレクターとして参加。その後、新規タイトルの開発ディレクターを務めたほか、データアナリストとして複数タイトルの分析と改善に貢献。現在はハイブリットカジュアルゲーム開発基盤SEEDの開発ディレクターを務める。" },
  goda: { name: "郷田 努", company: "株式会社ビジュアルアーツ", title: "シニアプロデューサー", img: "image/goda.webp", bio: "気づいたらゲーム業界26年目。namco、バンダイナムコ、TAITOなどでプロデューサーとしてクロスメディアプロジェクトの複数立ち上げや部門長を経験。 また中国企業やベンチャー企業など幅広い環境での業務経験を持っています。 現在も開発の最前線に立ちつつ、組織開発、人材開発、製品開発の戦略立案と実行を担当。" },
