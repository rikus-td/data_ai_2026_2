...
const speakerData = {
  ...
  goda: { 
    ...
    title: "シニアプロデューサー", 
    img: "image/goda.webp", 
    bio: "気づいたらゲーム業界26年目。namco、バンダイナムコ、TAITOなどでプロデューサーとしてクロスメディアプロジェクトの複数立ち上げや部門長を経験。 また中国企業やベンチャー企業など幅広い環境での業務経験を持っています。 現在も開発の最前線に立ちつつ、組織開発、人材開発、製品開発の戦略立案と実行を担当。" 
  },
  hosoda: { 
    name: "細田 誠司", 
    company: "TIS株式会社", 
