...
const speakerData = {
  ...
  matsuura: { 
    name: "松浦 遼", 
    company: "株式会社バンダイナムコネクサス", 
    title: "リードデータストラテジストデータストラテジー部 ゼネラルマネージャー", 
    img: "image/matsuura.webp", 
    bio: "大学卒業後、データ分析系のスタートアップ企業でゲーム分析部を率いる。複数のWWモバイルゲームAAAタイトルのアナリストを歴任し、チームビルド全般にも従事。その後、ゲーム企業へ移り分析チームを立ち上げ。2019年、株式会社バンダイナムコネクサス（当時BXD）に入社。データ戦略部を立ち上げ、グループ向けのデータ活用取組の実施や、グループ横断データ活用プロジェクト『データユニバース』の推進を担当。CEDECなど、エンターテインメント系やデータ系カンファレンスへの登壇も積極的に行う。" 
  },
  kitamura: { 
    name: "北村 有吾", 
    company: "株式会社MIXI", 
  ...
  nakamura: { 
    ...
    company: "AppMagic", 
    title: "", 
    img: "image/nakamura.webp", 
    bio: "日韓専門ITコンサル企業にて韓国に4年駐在後、Playwith, Wemadeの日本支社にて15年ほど事業・運営・マーケティングに従事。3年前にアカウントマネージャー、コンサルタントとして外資系Saas企業に転職し、現在はAppMagic韓国事業部長として日本から韓国事業を開拓中。" 
  },
  katou: { 
    name: "加藤 雅大", 
    company: "ワンダープラネット株式会社", 
    title: "執行役員SEED 管掌", 
    img: "image/katou.webp", 
    bio: "ワンダープラネット株式会社所属。開発ディレクションからデータ分析まで幅広く担当。スマートフォン向けゲーム「クラッシュフィーバー」の初期には運営ディレクターとして参加。その後、新規タイトルの開発ディレクターを務めたほか、データアナリストとして複数タイトルの分析と改善に貢献。現在はハイブリットカジュアルゲーム開発基盤SEEDの開発ディレクターを務める。" 
  },
  goda: { 
    name: "郷田 努", 
    company: "株式会社ビジュアルアーツ", 
    title: "経営戦略室長/ 開発本部 シニアプロデューサー", 
    img: "image/goda.webp", 
    bio: "ゲーム開発歴29年。プロデューサー／ディレクターとして多数のプロジェクトを成功に導くとともに、炎上案件の立て直しや組織改革にも精通。開発現場とマネジメントの両面から、実践的な知見をnoteで発信中。" 
  },
  hosoda: { 
    name: "細田 誠司", 
    company: "TIS株式会社", 
    title: "ビジネスイノベーション事業部ストラテジー＆デジタルコンサルティング第1部　マネージャー", 
    img: "image/hosoda.webp", 
    bio: "澪標アナリティクス株式会社在籍時に、月売上数億円規模の運営型タイトルのアナリストを担当し、「施策のためのデータ分析」をモットーに、会社・現場、ユーザー目線といった幅広い観点とデータを繋ぐ橋渡し役として様々な施策の意思決定に寄与。その後、複数のゲームタイトル分析をサポートし、現場の課題解決を支援。2026/4～TIS株式会社でゲーム分析の品質管理・マネジメント業務を担当。" 
  },
  nishikata: { 
    name: "西方 智晃", 
    company: "株式会社リーン・ニシカタ", 
    title: "代表取締役社長", 
    img: "image/nishikata.webp", 
    bio: "1974年6月28日生、静岡県富士宮市出身。株式会社ディー・エヌ・エー在籍中、ソーシャルゲーム黎明期より、 分析基盤構築の傍ら、自社サービスのログを分析し、 目まぐるしく変化するソーシャルゲームのメカニズムを探求する日々の中で、 大規模データ集計、機械学習、AIといったパラダイムシフトを実務を通じて経験。2018年、分析×マーケティングを活かしたモバイルアプリへのグロースハックフレームワークを日本に浸透させるべく株式会社リーン・ニシカタを創業。" 
  },
  saito: { 
  name: "斉藤 誠記", 
  company: "グラビティゲームアライズ株式会社", 
  title: "事業企画セクション", 
  img: "image/saito.webp", 
  bio: "30年以上にわたりゲーム業界に従事し、アーケード、家庭用、モバイルゲームなど多様なプラットフォームでディレクションおよびプロデュースを経験。現在は事業企画セクションにて、社内横断業務の推進、外部パートナーとの業務管理、AI事業推進など幅広い領域を担っている。" 
  },
  minimax: { 
    name: "Cherie Shi", 
    company: "MiniMax", 
    title: "Global Business Regional Manager", 
    img: "image/minimax.png", 
    bio: "" 
  }
};
...
const SOURCE_FIELD_NAME_CANDIDATES = [
  "ryuunyuupeji", "liuru_page", "liurupeji", "ryuunyu_page", "ryunyu_page", 
  "ryunyupeji", "inflow_page", "page_url", "entry_source", "source", "lead_source"
];
...
/**
 * Scroll & Mouse Interaction Effects
 */
...
/**
 * HubSpot Form Utilities & Initialization
 */
...
function bindConsentGuard(formRoot) {
  ...
  const clearError = () => { if (consentError) consentError.textContent = ''; };
...
function initEntryForm() {
  ...
  window.hbspt.forms.create({
    ...
    onBeforeFormSubmit: function ($form) {
      updateSourcePageOnForm(resolveFormRoot($form));
    },
